    ...
    <>
      <Routes>
        ...
        <Route path="/admin" element={<LayoutAdmin />}>
          ...
          <Route path={ADMIN_MANAGE_CATEGORIES} element={<ManageCategories />} />
          <Route path={ADMIN_MANAGE_PRICE} element={<ManagePrice />} />
          <Route path={ADMIN_MANAGE_ACREAGE} element={<ManageAcreage />} />
        </Route>
